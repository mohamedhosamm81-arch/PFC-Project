...
function normalizeState(saved) {
  ...
  merged.organizations = (saved.organizations || fresh.organizations).map(org => ({ type: 'Health unit', location: '', departments: [...ORGANIZATION_DEPARTMENTS], ...org }));
